...
// --- SEÇÃO AUTORA ---
let btnAutora = document.querySelector(".arrow");
let autoraAbout = document.querySelector(".secao-autora__about");

btnAutora.addEventListener("click", function(){
    if (autoraAbout.classList.contains("closed")) {
        autoraAbout.classList.remove("closed");
        btnAutora.classList.add("arrow-close");
    } else {
        autoraAbout.classList.add("closed");
        btnAutora.classList.remove("arrow-close");
    }
});
